...
@AndroidEntryPoint
public class PoolCarReservationsListActivity extends BaseActivity {
    @Override
    public void onCreate(Bundle savedStateInstance) {
        super.onCreate(savedStateInstance);
        Intent i = getIntent();
        NavigationUtil.navigate(this, R.id.fragmentFrame, new PoolCarReservationsListFragment(), null);
    }
}
